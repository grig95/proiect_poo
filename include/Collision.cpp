...
Collision::Collision(double timeElapsed, const Vector &contactPoint, Collider &col1, Collider &col2,
                     ...
                     timeElapsed(timeElapsed), contactPoint(contactPoint), col1(col1), col2(col2), transform1(t1), transform2(t2), normal1(normal1), normal2(normal2) {}
...
Collider& Collision::getCol1() const { return col1; }
Collider& Collision::getCol2() const { return col2; }
